...
$executives = $db->fetchAll(
    "SELECT * FROM team_members $where AND category = 'executive' ORDER BY position_order ASC",
    $params
);

// Get other members
$members = $db->fetchAll(
    "SELECT * FROM team_members $where AND category != 'executive' ORDER BY position_order ASC, name ASC",
    $params
);
?>
<!DOCTYPE html>
                ...
                <div class="bg-light-navy/50 backdrop-blur-sm rounded-lg overflow-hidden border border-slate-800 hover:border-accent/30 transition group" 
                    ...
                    <div class="aspect-square relative overflow-hidden">
                        <?php if ($member['photo_path']): ?>
                            <img src="../uploads/team/<?= htmlspecialchars($member['photo_path']) ?>" 
                    ...
                    <div class="p-6 text-center -mt-12 relative">
                        ...
                        <p class="text-accent font-medium"><?= htmlspecialchars($member['role']) ?></p>
